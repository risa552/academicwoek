...
@section('title','เพิ่มข้อมูลผู้ดูแลระบบ')
@section('content')
<div class="container">
    <div class="row">
        <div class="col-md-10">
            <div class="panel panel-default">  
            <div class="panel-heading">เพิ่มข้อมูลผู้ดูแลระบบ</div>
                <form class="form-horizontal" action="/action_page.php" style="margin-top:15px;">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="email">รหัสผู้ดูแลระบบ:</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group"> 
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-secondary"><a  href="/admin" class="fa fa-arrow-left" aria-hidden="true"> back</a></button>

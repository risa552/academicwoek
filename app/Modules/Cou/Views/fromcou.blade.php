...
<div class="container">
    <div class="row">
        <div class="col-md-10">
            ...
            <div class="panel-heading">เพิ่มข้อมูลหลักสูตร</div>
                <form class="form-horizontal" action="/action_page.php" style="margin-top:15px;">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="email">รหัสหลักสูตร:</label>
                        <div class="col-sm-10">
                        <input type="email" class="form-control" id="email" placeholder="Enter email">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="pwd">ชื่อหลักสูตร:</label>
                        <div class="col-sm-10"> 

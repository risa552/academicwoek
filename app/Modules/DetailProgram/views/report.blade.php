        ...
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    รายงานแผนการเรียน  {{$cou_name}} {{$year_name}}
                    ...
                    <a  class="btn btn-default fa fa-print pull-right" href="/print-program/{{$programID}}/{{$branID}}" aria-hidden="true"></a>
                </div>
            <form>
                <div class="panel-body">
                    <h5 style="text-align:center;">แผนการเรียน</h5>
                    <h4 style="border:1px solid #ccc;padding:5px;text-align:center;">
                    หลักสูตร : {{$course}}   สาขา : {{$branche}}   ปีการศึกษา : {{$year_name}}  ใช้หลักสูตรปรับปรุงปี  : {{$cou_year}}
                    </h4>

...
@section('title','แก้ไขข้อมูลภาคเรียน')
@section('content')
<div class="container">
    <div class="row">
        <div class="col-md-10">
            <div class="panel panel-default">  
            <div class="panel-heading">แก้ไขข้อมูลภาคเรียน</div>
                <form class="form-horizontal" action="#" style="margin-top:15px;">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="pwd">วัน/เดือน/ปี ที่เข้าเรียน:</label>
                        <div class="col-sm-10"> 
                        <input type="password" class="form-control" id="pwd" placeholder="Enter password">
                        </div>
                    </div>
